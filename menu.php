...
$result=mysqli_query($conn,"SELECT * FROM menu WHERE category_id='1'");
$result1=mysqli_query($conn,"SELECT * FROM menu WHERE category_id='2'");
$result3=mysqli_query($conn,"SELECT * FROM menu WHERE category_id='3'");
?>
                        ...
                        <div class="row">
                            <div class="col-md-5">
                                <div class="left-image">
                                    <img src="img/breakfastmenu.jpg" alt="Breakfast">
                                </div>
                            </div>
                            <div class="col-md-7">
                ...
                <div class="col-md-10 col-md-offset-1">
                    <div class="dinner-menu-content">
                        <div class="row">
                            <div class="col-md-5">
                                <div class="left-image">
                                    <img src="img/dinnermenu.png" alt="">
                                </div>
                            </div>
                            <div class="col-md-7">
                                <h2>Dinner Menu</h2>
